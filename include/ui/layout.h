...
// Full-screen views (ViewType_Scene): two-row button prompt area at bottom with keepout.
// Row 0 = icons only, row 1 = text only (double-row slots). Content must stay above SCENE_CONTENT_BOTTOM.
#define SCENE_FOOTER_ROW2_Y (SCENE_VH - SCENE_KEEPOUT * 2)
#define SCENE_FOOTER_ROW1_Y (SCENE_FOOTER_ROW2_Y - SCENE_ROW_SIZE)
#define SCENE_FOOTER_TOP SCENE_FOOTER_ROW1_Y
