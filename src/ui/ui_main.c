...
static void initViews(void) {
  ...
  mainSceneSetMenuView(menuGetView());
  mainSceneSetViewOptionsView(viewOptionsPopupGetView());
  mainSceneSetTitleOptionsView(titleOptionsGetView());
  mainSceneSetTitleOptionsData(titleOptionsGetData());
  menuSetExitModalView(exitModalGetView());
}
