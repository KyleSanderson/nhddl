...
static void exitModalDraw(View *v, int zOrder) {
  ...
  uiDrawPrompt(gsGlobal, SCENE_PROMPT_SLOT_CENTER_X(0), SCENE_FOOTER_ROW1_Y, SCENE_FOOTER_ROW2_Y, zOrder + 1, HeaderTextColor, ICON_CROSS, "Yes");
  uiDrawPrompt(gsGlobal, SCENE_PROMPT_SLOT_CENTER_X(3), SCENE_FOOTER_ROW1_Y, SCENE_FOOTER_ROW2_Y, zOrder + 1, HeaderTextColor, ICON_CIRCLE, "No");
}
